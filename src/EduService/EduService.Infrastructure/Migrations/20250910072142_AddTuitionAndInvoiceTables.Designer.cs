...
namespace EduService.Infrastructure.Migrations
{
    ...
    [Migration("20250910072142_AddTuitionAndInvoiceTables")]
    partial class AddTuitionAndInvoiceTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduService.Domain.Entities.EduInvoice", b =>
                {
            ...
            modelBuilder.Entity("EduService.Domain.Entities.EduStudent", b =>
                {
                    ...
                    b.Property<string>("AdmissionDecisionDate")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("AdmissionDecisionNumber")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");
                    ...
                    b.Property<string>("GraduationDecisionDate")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("GraduationDecisionNumber")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<bool?>("IsLinkedDegree")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("StatusDecisionNumber")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<int?>("TrainingFromYear")
                        .HasMaxLength(100)
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduService.Domain.Entities.EduTuitionFee", b =>
                {
                    b.Property<Guid>("TuitionFeeID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EduService.Domain.Entities.EduInvoice", b =>
                {
                    b.HasOne("EduService.Domain.Entities.EduTuitionFee", "TuitionFee")
                        .WithMany("Invoices")
